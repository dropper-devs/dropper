...
export default function ParallaxField() {
  return (
    <ParallaxController>
      <svg
        className="space-layer space-layer-slow"
      ...
      >
        ...
        <ellipse
          className="space-orbit"
          cx="1320"
          cy="230"
          rx="205"
          ry="54"
          transform="rotate(-17 1320 230)"
        />
        <circle
          className="space-orb"
          fill="url(#planet-a)"
        ...
        <g transform="rotate(-17 1320 230)">
          <path
            className="space-orbit front"
            d="M1115 230 A 205 54 0 0 0 1525 230"
          />
        </g>
      ...
      <svg
        className="space-layer space-layer-mid"
        viewBox="0 0 1600 1000"
        preserveAspectRatio="xMidYMid slice"
      >
        <defs>
        ...
        <ellipse
          className="space-orbit fine"
          cx="470"
          cy="615"
          rx="118"
          ry="30"
          transform="rotate(21 470 615)"
        />
        <circle
          className="space-orb"
          fill="url(#planet-b)"
        ...
        <g transform="rotate(21 470 615)">
          <path
            className="space-orbit fine front"
            d="M352 615 A 118 30 0 0 0 588 615"
          />
        </g>
      ...
      <svg
        className="space-layer space-layer-fast"
        viewBox="0 0 1600 1000"
        preserveAspectRatio="xMidYMid slice"
      >
        <defs>
