...
export default function SiteEnhancements() {
  ...
  useEffect(() => {
    function handleClick(event: MouseEvent) {
      ...
      // "top" returns to the very top of the page; every other id scrolls its
      // section into view. The fixed-nav offset lives in CSS (scroll-margin-top),
      // and the ease honors prefers-reduced-motion through the stylesheet's
      // scroll-behavior — so no hand-rolled rAF animation is needed.
      const target =
        targetId === "top" ? null : document.getElementById(targetId);
